export function ContactForm() {
  ...
  .contact-form{
    ...
    .contact-form [required]:valid{
        border: medium solid var(--form-ok-color);
    }

    .contact-form [required]:invalid{
        border: medium solid var(--form-error-color);
    }
  ...
  <input type="email" name="email" placeholder="Escribe tu correo " title="E-mail incorrecto" pattern="^[a-z0-9]+(\\.[_a-z0-9]+)*@[a-z0-9-]+(\\.[a-z0-9-]+)*(\\.[a-z]{2,15})$" required>
  <input type="text" name="subject" placeholder="Asunto a tratar" required title="El asunto es requerido">
  <textarea name="comments" cols="50" rows="5" placeholder="Escribe tus comentarios" title="Tu comentario no puede exceder los 255 caracteres." data-pattern="^.{1,255}$" required></textarea>
  ...
  function validationsForm() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/troncopeta@hotmail.com", {
        method: "POST",
